    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.center}>
          ...
          >
            <Text style={styles.permissionButtonText}>Enter BA Set ID Manually</Text>
          </TouchableOpacity>
        </View>
          ...
          >
            ...
            <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                ...
                <Text style={styles.modalTitle}>Enter BA Set ID</Text>
                <View style={styles.modalHeaderSpacer} />
              </View>

              <View style={styles.modalBody}>
                <Ionicons name="information-circle" size={40} color={BLUE} style={styles.infoIcon} />
                <Text style={styles.modalInstructions}>Enter the BA Set ID manually</Text>
                <Text style={styles.modalSubtitle}>
                  Make sure to enter the correct BA Set identification number
                </Text>

                <View style={styles.inputContainer}>
                  <Text style={styles.inputLabel}>BA Set ID</Text>
                  <TextInput
                    style={styles.input}
                    placeholder="e.g., BA-SET-042"
      ...
      >
        ...
        <View style={styles.manualButtonContainer}>
          ...
          >
            ...
            <Text style={styles.manualButtonText}>Enter BA Set ID Manually</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
